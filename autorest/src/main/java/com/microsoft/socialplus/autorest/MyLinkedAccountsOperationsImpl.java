...
public final class MyLinkedAccountsOperationsImpl implements MyLinkedAccountsOperations {
    ...
    interface MyLinkedAccountsService {
        ...
        @GET("v0.4/users/me/linked_accounts")
        ...
        @Headers("Content-Type: application/json; charset=utf-8")
        @POST("v0.4/users/me/linked_accounts")
        ...
        @Headers("Content-Type: application/json; charset=utf-8")
        @HTTP(path = "v0.4/users/me/linked_accounts/{identityProvider}", method = "DELETE", hasBody = true)
