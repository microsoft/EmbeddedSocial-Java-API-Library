...
public final class TopicReportsOperationsImpl implements TopicReportsOperations {
    ...
    interface TopicReportsService {
        ...
        @POST("v0.3/topics/{topicHandle}/reports")
        Call<ResponseBody> postReport(@Path("topicHandle") String topicHandle, @Body PostReportRequest postReportRequest, @Header("appkey") String appkey, @Header("Authorization") String authorization, @Header("UserHandle") String userHandle);
    ...
    public ServiceResponse<Object> postReport(String topicHandle, PostReportRequest postReportRequest, String authorization) throws ServiceException, IOException, IllegalArgumentException {
        ...
        Call<ResponseBody> call = service.postReport(topicHandle, postReportRequest, appkey, authorization, userHandle);
     ...
     * @return the Object object wrapped in {@link ServiceResponse} if successful.
     */
    public ServiceResponse<Object> postReport(String topicHandle, PostReportRequest postReportRequest, String authorization, String appkey, String userHandle) throws ServiceException, IOException, IllegalArgumentException {
        if (topicHandle == null) {
            throw new IllegalArgumentException("Parameter topicHandle is required and cannot be null.");
        }
        if (postReportRequest == null) {
     ...
     * @return the {@link Call} object
     */
    public ServiceCall postReportAsync(String topicHandle, PostReportRequest postReportRequest, String authorization, String appkey, String userHandle, final ServiceCallback<Object> serviceCallback) throws IllegalArgumentException {
        if (serviceCallback == null) {
            throw new IllegalArgumentException("ServiceCallback is required for async calls.");
        }
        if (topicHandle == null) {
