...
public final class CommentLikesOperationsImpl implements CommentLikesOperations {
    ...
    interface CommentLikesService {
        ...
        @GET("v0.2/comments/{commentHandle}/likes")
        Call<ResponseBody> getLikes(@Path("commentHandle") String commentHandle, @Query("cursor") String cursor, @Query("limit") Integer limit, @Header("appkey") String appkey, @Header("Authorization") String authorization);

        @Headers("Content-Type: application/json; charset=utf-8")
        @POST("v0.2/comments/{commentHandle}/likes")
        Call<ResponseBody> postLike(@Path("commentHandle") String commentHandle, @Header("Authorization") String authorization);

        @Headers("Content-Type: application/json; charset=utf-8")
        @HTTP(path = "v0.2/comments/{commentHandle}/likes/me", method = "DELETE", hasBody = true)
     ...
     */
    public ServiceResponse<FeedResponseUserCompactView> getLikes(String commentHandle, String cursor, Integer limit, String appkey, String authorization) throws ServiceException, IOException, IllegalArgumentException {
     ...
     */
    public ServiceCall getLikesAsync(String commentHandle, String cursor, Integer limit, String appkey, String authorization, final ServiceCallback<FeedResponseUserCompactView> serviceCallback) throws IllegalArgumentException {
    ...
    public ServiceResponse<Object> postLike(String commentHandle, String authorization) throws ServiceException, IOException, IllegalArgumentException {
        ...
        Call<ResponseBody> call = service.postLike(commentHandle, authorization);
    ...
    public ServiceResponse<Object> deleteLike(String commentHandle, String authorization) throws ServiceException, IOException, IllegalArgumentException {
        ...
        Call<ResponseBody> call = service.deleteLike(commentHandle, authorization);
