...
public final class CommentLikesOperationsImpl implements CommentLikesOperations {
     ...
     */
    public CommentLikesOperationsImpl(Retrofit retrofit, EmbeddedSocialClient client) {
    ...
    interface CommentLikesService {
        ...
        @Headers("Content-Type: application/json; charset=utf-8")
        @HTTP(path = "v0.5/comments/{commentHandle}/likes/me", method = "DELETE", hasBody = true)
     ...
     */
    public ServiceResponse<FeedResponseUserCompactView> getLikes(String commentHandle, String authorization) throws ServiceException, IOException, IllegalArgumentException {
        ...
        Call<ResponseBody> call = service.getLikes(commentHandle, cursor, limit, authorization);
     ...
     */
    public ServiceCall getLikesAsync(String commentHandle, String authorization, final ServiceCallback<FeedResponseUserCompactView> serviceCallback) throws IllegalArgumentException {
     ...
     * @return the FeedResponseUserCompactView object wrapped in {@link ServiceResponse} if successful.
     */
    public ServiceResponse<FeedResponseUserCompactView> getLikes(String commentHandle, String authorization, String cursor, Integer limit) throws ServiceException, IOException, IllegalArgumentException {
        if (commentHandle == null) {
            throw new IllegalArgumentException("Parameter commentHandle is required and cannot be null.");
        }
        if (authorization == null) {
     ...
     * @return the {@link Call} object
     */
    public ServiceCall getLikesAsync(String commentHandle, String authorization, String cursor, Integer limit, final ServiceCallback<FeedResponseUserCompactView> serviceCallback) throws IllegalArgumentException {
        if (serviceCallback == null) {
            throw new IllegalArgumentException("ServiceCallback is required for async calls.");
        }
        if (commentHandle == null) {
